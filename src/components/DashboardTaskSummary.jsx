  ...
  return (
    <GlassCard elevated className="p-4 md:p-5">
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-3">
        <div className="surface-subtle rounded-xl border border-white/[0.06] bg-white/[0.03] px-4 py-3 backdrop-blur-[20px]">
          <p className="text-[11px] text-white/50">Completed Today</p>
          <p className="mt-1.5 text-lg font-semibold tracking-tight text-white">{completedToday}</p>
        </div>
        <div className="surface-subtle rounded-xl border border-white/[0.06] bg-white/[0.03] px-4 py-3 backdrop-blur-[20px]">
          <p className="text-[11px] text-white/50">Pending</p>
