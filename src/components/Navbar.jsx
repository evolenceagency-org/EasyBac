...
const Navbar = () => {
  ...
  return (
    ...
    >
      <nav className="flex max-w-fit flex-wrap items-center justify-center gap-3 rounded-2xl border border-white/10 bg-black/40 px-4 py-3 shadow-xl backdrop-blur-xl sm:gap-6 md:flex-nowrap md:px-6">
